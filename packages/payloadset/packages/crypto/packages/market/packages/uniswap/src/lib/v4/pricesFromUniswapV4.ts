...
import { PoolIdType, tokenRegistryValueToToken } from './UniswapV4TokenContracts.ts'

export const priceFromUniswap4 = async (poolId: PoolIdType, provider: Provider): Promise<UniswapCryptoPair> => {
