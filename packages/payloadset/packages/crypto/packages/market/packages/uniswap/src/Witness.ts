...
import type {
  UniswapCryptoMarketPayload } from '@xyo-network/uniswap-crypto-market-payload-plugin'
import {
...
import { createUniswapPoolContracts, pricesFromUniswap3, UniswapPoolContracts } from './lib/index.ts'
